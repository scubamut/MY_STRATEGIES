# https://www.quantopian.com/posts/equity-momentumhttps://www.quantopian.com/posts/equity-momentum
...
MAX_SHORT_SECTOR_SIZE = 0.15
MAX_LONG_SECTOR_SIZE = 0.15
...
def my_rebalance(context, data):
    ...
    data_end = -1 * (context.exclude_days + 1)  # exclude most recent data
    ...
    print
    'equity exposure should be %s ' % equity_weight
